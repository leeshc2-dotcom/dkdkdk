...
export const trustPillars: TrustPillar[] = [
  ...
  {
    title: "당신의 가치를 증명하는 선제적 권리 쉴드",
    icon: "Languages",
    description: "소중한 창작 자산이 무단으로 훼손되지 않도록 가장 신속하게 움직이는 방패가 되겠습니다 온·오프라인의 모든 위험 요소를 선제적으로 통제하고 전담 그룹의 정밀한 대응을 통해 비즈니스의 지속 가능한 안정성을 보장합니다",
    metric: "PROTECTION",
